...
/// <summary>
/// Represents Modern UI specific RadioButton
/// </summary>
...
public class RadioButton : System.Windows.Controls.RadioButton, IRibbonControl, IQuickAccessItemProvider, ILargeIconProvider, IMediumIconProvider, ISimplifiedRibbonControl {
    ...
    /// </summary>
    public static readonly DependencyProperty KeyTipProperty = Modern.KeyTip.KeysProperty.AddOwner(typeof(RadioButton));
    ...
    /// <inheritdoc />
    protected override AutomationPeer OnCreateAutomationPeer() => new Modern.Automation.Peers.RibbonRadioButtonAutomationPeer(this);
}