...
public class RibbonGroupBox : HeaderedItemsControl, IQuickAccessItemProvider, IDropDownControl, IKeyTipedControl, IHeaderedControl, ILogicalChildSupport, IMediumIconProvider, ISimplifiedStateControl, ILargeIconProvider {
    ...
    /// </summary>
    public static readonly DependencyProperty KeyTipProperty = Modern.KeyTip.KeysProperty.AddOwner(typeof(RibbonGroupBox));
    ...
    public bool TryClearCacheAndResetStateAndScaleAndNotifyParentRibbonGroupsContainer() {
        ...
        // For reference https://github.com/Modernribbon/Modern.Ribbon/issues/834
    ...
    private static void OnIsDropDownOpenChanged(DependencyObject d, DependencyPropertyChangedEventArgs e) {
        ...
        (UIElementAutomationPeer.FromElement(groupBox) as Modern.Automation.Peers.RibbonGroupBoxAutomationPeer)?.RaiseExpandCollapseAutomationEvent(oldValue, newValue);
    ...
    /// <inheritdoc />
    protected override AutomationPeer OnCreateAutomationPeer() => new Modern.Automation.Peers.RibbonGroupBoxAutomationPeer(this);
}