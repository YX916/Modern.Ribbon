...
/// <summary>
/// Represents custom Modern UI TextBox
/// </summary>
...
public class TextBox : System.Windows.Controls.TextBox, IQuickAccessItemProvider, IRibbonControl, IMediumIconProvider, ISimplifiedRibbonControl {
    ...
    /// <inheritdoc cref="Modern.KeyTip.KeysProperty"/>
    public static readonly DependencyProperty KeyTipProperty = Modern.KeyTip.KeysProperty.AddOwner(typeof(TextBox));
    ...
    /// <inheritdoc />
    protected override AutomationPeer OnCreateAutomationPeer() => new Modern.Automation.Peers.RibbonTextBoxAutomationPeer(this);
}