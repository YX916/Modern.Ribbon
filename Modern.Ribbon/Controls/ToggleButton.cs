...
public class ToggleButton : System.Windows.Controls.Primitives.ToggleButton, IToggleButton, IRibbonControl, IQuickAccessItemProvider, ILargeIconProvider, IMediumIconProvider, ISimplifiedRibbonControl {
    ...
    public static readonly DependencyProperty KeyTipProperty = Modern.KeyTip.KeysProperty.AddOwner(typeof(ToggleButton));
    ...
    /// <inheritdoc />
    protected override AutomationPeer OnCreateAutomationPeer() => new Modern.Automation.Peers.RibbonToggleButtonAutomationPeer(this);
}