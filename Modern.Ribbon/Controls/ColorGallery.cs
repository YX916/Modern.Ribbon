...
public class ColorGradientItemTemplateSelector : DataTemplateSelector {
    ...
    public override DataTemplate? SelectTemplate(object item, DependencyObject container) {
        ...
        if (index < colorGallery.Columns) {
            return listBox.TryFindResource("Modern.Ribbon.DataTemplates.GradientColorTopData") as DataTemplate;
        }

        if (index >= listBox.Items.Count - colorGallery.Columns) {
            return listBox.TryFindResource("Modern.Ribbon.DataTemplates.GradientColorBottomData") as DataTemplate;
        }

        return listBox.TryFindResource("Modern.Ribbon.DataTemplates.GradientColorCenterData") as DataTemplate;
    }
}
