...
public class Ribbon : Control, ILogicalChildSupport {
    ...
    private static void OnIsMinimizedChanged(DependencyObject d, DependencyPropertyChangedEventArgs e) {
        ...
        (UIElementAutomationPeer.FromElement(ribbon) as Modern.Automation.Peers.RibbonAutomationPeer)?.RaiseExpandCollapseAutomationEvent(!oldValue, !newValue);
    }
    ...
    /// <inheritdoc />
    protected override AutomationPeer OnCreateAutomationPeer() => new Modern.Automation.Peers.RibbonAutomationPeer(this);
