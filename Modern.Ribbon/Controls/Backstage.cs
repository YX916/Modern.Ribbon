...
public class Backstage : RibbonControl {
    ...
    private static void OnIsOpenChanged(DependencyObject d, DependencyPropertyChangedEventArgs e) {
        ...
        (UIElementAutomationPeer.FromElement(control) as Modern.Automation.Peers.RibbonBackstageAutomationPeer)?.RaiseExpandCollapseAutomationEvent(oldValue, newValue);
    }
    ...
    protected virtual void Hide() {
        // potentially fixes https://github.com/Modernribbon/Modern.Ribbon/issues/489
    ...
    private void ShowAdorner() {
        ...
        if (this.AreAnimationsEnabled
            && this.TryFindResource("Modern.Ribbon.Storyboards.Backstage.IsOpenTrueStoryboard") is Storyboard storyboard) {
    ...
    private void HideAdornerAndRestoreParentProperties() {
        ...
        if (this.AreAnimationsEnabled
            && this.TryFindResource("Modern.Ribbon.Storyboards.Backstage.IsOpenFalseStoryboard") is Storyboard storyboard) {
            storyboard = storyboard.Clone();
    ...
    /// <inheritdoc />
    protected override AutomationPeer OnCreateAutomationPeer() => new Modern.Automation.Peers.RibbonBackstageAutomationPeer(this);
}