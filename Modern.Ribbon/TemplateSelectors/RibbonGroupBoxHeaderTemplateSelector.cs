namespace Modern.TemplateSelectors;
...
public class RibbonGroupBoxHeaderTemplateSelector : DataTemplateSelector {
    ...
    public override DataTemplate SelectTemplate(object item, DependencyObject container) {
        ...
        if (RibbonGroupBox.GetIsCollapsedHeaderContentPresenter(element)) {
            return (DataTemplate)element.FindResource("Modern.Ribbon.DataTemplates.RibbonGroupBox.TwoLineHeader");
        }

        return (DataTemplate)element.FindResource("Modern.Ribbon.DataTemplates.RibbonGroupBox.OneLineHeader");
    }
}