...
public class RibbonStateStorage : IRibbonStateStorage {
    ...
    protected string IsolatedStorageFileName {
        get {
            ...
            this.isolatedStorageFileName = "Modern.Ribbon.State." + BitConverter.ToInt32(md5Hasher.ComputeHash(Encoding.Default.GetBytes(stringForHash)), 0).ToString("X");
            return this.isolatedStorageFileName;
        }
    }
    ...
    public virtual void Reset() {
        ...
        foreach (var filename in storage.GetFileNames("*Modern.Ribbon.State*")) {
