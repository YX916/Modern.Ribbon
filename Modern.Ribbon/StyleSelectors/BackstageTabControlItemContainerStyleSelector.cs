namespace Modern.StyleSelectors;

using System.Windows;
using System.Windows.Controls;
using Button = Modern.Button;
...
public class BackstageTabControlItemContainerStyleSelector : StyleSelector {
    ...
    public override Style? SelectStyle(object item, DependencyObject container) {
        switch (item) {
            case Button _:
                return (container as FrameworkElement)?.TryFindResource("Modern.Ribbon.Styles.BackstageTabControl.Button") as Style;

            case SeparatorTabItem _:
                return (container as FrameworkElement)?.TryFindResource("Modern.Ribbon.Styles.BackstageTabControl.SeparatorTabItem") as Style;
        }
