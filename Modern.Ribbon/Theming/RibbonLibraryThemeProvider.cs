namespace Modern.Theming;

using System.Collections.Generic;
using System.Globalization;
using System.Windows.Media;
using ControlzEx.Theming;
using Modern.Helpers.ColorHelpers;

/// <summary>
/// Provides theme resources from Modern.Ribbon.
/// </summary>
public class RibbonLibraryThemeProvider : LibraryThemeProvider {
    ...
    public override void FillColorSchemeValues(Dictionary<string, string> values, RuntimeThemeColorValues colorValues) {
        values.Add("Modern.Ribbon.Colors.AccentBase", colorValues.AccentColor.ToString());
        values.Add("Modern.Ribbon.Colors.Accent80", colorValues.AccentColor80.ToString());
        values.Add("Modern.Ribbon.Colors.Accent60", colorValues.AccentColor60.ToString());
        values.Add("Modern.Ribbon.Colors.Accent40", colorValues.AccentColor40.ToString());
        values.Add("Modern.Ribbon.Colors.Accent20", colorValues.AccentColor20.ToString());

        values.Add("Modern.Ribbon.Colors.Highlight", colorValues.HighlightColor.ToString());
        values.Add("Modern.Ribbon.Colors.IdealForeground", colorValues.IdealForegroundColor.ToString());
